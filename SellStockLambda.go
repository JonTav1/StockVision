...
func handler(request events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	...
	if stockChoice.Amount >= stockDB.Amount {
		stockDB.Amount = 0
		stockDB.AveragePrice = 0.0
		removeStockDB(stockDB.Username, stockDB.Ticker)
	} else {
...
func removeStockDB(username string, ticker string) {
